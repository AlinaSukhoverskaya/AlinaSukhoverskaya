...
|<a href="https://github.com/AlinaSukhoverskaya/Projects/tree/main/Dashboards%20News%20Feed"><b>News Feed Dashboards</b></a> |<b>Data:</b><p>This dataset contains information about users and their interactions with the news feed and messenger.</p><b>Goal:</b><p>Set up basic dashboards that show key audience metrics and key events of our product.</p><p><b>Tasks:</b></p><p><b>1. News Feed Dashboard</b></p><p>Provide information about:</p><ul><li>KPIs</li><li>User activity</li><li>Most popular posts</li><li>Most active users</li><li>Action distribution (by hour, day of the week, source, OS)</li><li>Users distribution (by country, age, gender)</li></ul><b>2. News Feed Real-Time Dashboard</b><p>Provide information about:</p><ul><li>Today KPIs</li><li>Short time interval KPIs and comparison with the previous time interval</li><li>Today user activity and comparison with the value a day ago and a week ago</li><li>Today most popular posts</li><li>Today most active users</li></ul><b>3. News Feed And Messenger Dashboard</b><p>Describe the interaction of two services - news feed and messenger:</p><ul><li>What active audience the application has by day, i.e. users who use both the news feed and the messenger</li><li>How many users use only the news feed and do not use messages and vice versa</li><li>User activity by service</li></ul>|Superset, ClickHouse|
